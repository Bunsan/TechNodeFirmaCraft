...
//#ADD SHAPED
	...
	recipes.addShaped(<RedLogic:redlogic.plainBlock> * 16, [[<ore:blockSand>, <ore:stoneBrick>, <ore:blockSand>], [<ore:ingotIron>, <ore:craftingToolHardHammer>.transformDamage(), <ore:ingotIron>], [<ore:blockSand>, <ore:stoneBrick>, <ore:blockSand>]]);
	recipes.addShaped(<RedLogic:redlogic.arrayCells:2>, [[<ore:stoneAny>, <RedLogic:redlogic.wire>, <ore:stoneAny>], [<RedLogic:redlogic.wire>, <minecraft:repeater>, <RedLogic:redlogic.wire>], [<ore:stoneAny>, <RedLogic:redlogic.wire>, <ore:stoneAny>]]);
	recipes.addShaped(<RedLogic:redlogic.arrayCells:1>, [[<ore:stoneAny>, <RedLogic:redlogic.wire>, <ore:stoneAny>], [<RedLogic:redlogic.wire>, <minecraft:redstone_torch>, <RedLogic:redlogic.wire>], [<ore:stoneAny>, <RedLogic:redlogic.wire>, <ore:stoneAny>]]);
	recipes.addShaped(<RedLogic:redlogic.arrayCells>, [[<ore:stoneAny>, <RedLogic:redlogic.wire>, <ore:stoneAny>], [<RedLogic:redlogic.wire>, <RedLogic:redlogic.wire>, <RedLogic:redlogic.wire>], [<ore:stoneAny>, <RedLogic:redlogic.wire>, <ore:stoneAny>]]);
