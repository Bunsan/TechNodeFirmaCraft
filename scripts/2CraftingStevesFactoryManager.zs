...
// ================================================================================
//#ADD SHAPELESS
	recipes.addShapeless(<StevesFactoryManager:BlockCableSignName>, [<StevesFactoryManager:BlockCableName>, <ore:dyeBlack>, <minecraft:feather>, <ore:itemHammer>, <ore:craftingToolHardChisel>.transformDamage()]);
	recipes.addShapeless(<StevesFactoryManager:BlockCableClusterName>, [<StevesFactoryManager:BlockCableName>, <minecraft:ender_pearl>, <minecraft:ender_pearl>, <minecraft:ender_pearl>, <ore:itemHammer>, <ore:craftingToolHardChisel>.transformDamage()]);
	recipes.addShapeless(<StevesFactoryManager:BlockCableBreakerName>, [<StevesFactoryManager:BlockCableName>, <terrafirmacraft:item.Wrought Iron Pick>, <minecraft:dropper>, <ore:itemHammer>, <ore:craftingToolHardChisel>.transformDamage()]);
	recipes.addShapeless(<StevesFactoryManager:BlockCableBUDName>, [<StevesFactoryManager:BlockCableName>, <ore:oreJet>, <ore:oreJet>, <ore:oreJet>, <ore:itemHammer>, <ore:craftingToolHardChisel>.transformDamage()]);
	recipes.addShapeless(<StevesFactoryManager:BlockCableIntakeName>, [<StevesFactoryManager:BlockCableName>, <minecraft:dropper>, <minecraft:hopper>, <minecraft:hopper>, <ore:itemHammer>, <ore:craftingToolHardChisel>.transformDamage()]);
	recipes.addShapeless(<StevesFactoryManager:BlockCableInputName>, [<StevesFactoryManager:BlockCableName>, <ore:dustRedstone>, <ore:itemHammer>, <ore:craftingToolHardChisel>.transformDamage()]);
	recipes.addShapeless(<StevesFactoryManager:BlockCableOutputName>, [<StevesFactoryManager:BlockCableName>, <ore:dustRedstone>, <ore:dustRedstone>, <minecraft:redstone>, <ore:itemHammer>, <ore:craftingToolHardChisel>.transformDamage()]);
