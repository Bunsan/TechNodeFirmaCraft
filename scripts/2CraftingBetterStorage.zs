...
//# Chests
	recipes.addShaped(<betterstorage:reinforcedChest>.withTag({Material: "iron"}), [[<ore:ingotIron>, <ore:logWood>, <ore:ingotIron>], [<ore:logWood>, <ore:craftingChest>, <ore:logWood>], [<ore:ingotIron>, <ore:craftingToolHardSaw>.transformDamage(), <ore:ingotIron>]]);
	recipes.addShaped(<betterstorage:reinforcedChest>.withTag({Material: "gold"}), [[<ore:ingotGold>, <ore:logWood>, <ore:ingotGold>], [<ore:logWood>, <ore:craftingChest>, <ore:logWood>], [<ore:ingotGold>, <ore:craftingToolHardSaw>.transformDamage(), <ore:ingotGold>]]);
	recipes.addShaped(<betterstorage:reinforcedChest>.withTag({Material: "diamond"}), [[<ore:craftingBlueGem>, <ore:logWood>, <ore:craftingBlueGem>], [<ore:logWood>, <ore:craftingChest>, <ore:logWood>], [<ore:craftingBlueGem>, <ore:craftingToolHardSaw>.transformDamage(), <ore:craftingBlueGem>]]);
	recipes.addShaped(<betterstorage:reinforcedChest>.withTag({Material: "emerald"}), [[<ore:craftingGreenGem>, <ore:logWood>, <ore:craftingGreenGem>], [<ore:logWood>, <ore:craftingChest>, <ore:logWood>], [<ore:craftingGreenGem>, <ore:craftingToolHardSaw>.transformDamage(), <ore:craftingGreenGem>]]);
	recipes.addShaped(<betterstorage:reinforcedChest>.withTag({Material: "copper"}), [[<ore:ingotCopper>, <ore:logWood>, <ore:ingotCopper>], [<ore:logWood>, <ore:craftingChest>, <ore:logWood>], [<ore:ingotCopper>, <ore:craftingToolHardSaw>.transformDamage(), <ore:ingotCopper>]]);
	recipes.addShaped(<betterstorage:reinforcedChest>.withTag({Material: "tin"}), [[<ore:ingotTin>, <ore:logWood>, <ore:ingotTin>], [<ore:logWood>, <ore:craftingChest>, <ore:logWood>], [<ore:ingotTin>, <ore:craftingToolHardSaw>.transformDamage(), <ore:ingotTin>]]);
	recipes.addShaped(<betterstorage:reinforcedChest>.withTag({Material: "silver"}), [[<ore:ingotSilver>, <ore:logWood>, <ore:ingotSilver>], [<ore:logWood>, <ore:craftingChest>, <ore:logWood>], [<ore:ingotSilver>, <ore:craftingToolHardSaw>.transformDamage(), <ore:ingotSilver>]]);
	recipes.addShaped(<betterstorage:reinforcedChest>.withTag({Material: "zinc"}), [[<ore:ingotZinc>, <ore:logWood>, <ore:ingotZinc>], [<ore:logWood>, <ore:craftingChest>, <ore:logWood>], [<ore:ingotZinc>, <ore:craftingToolHardSaw>.transformDamage(), <ore:ingotZinc>]]);
	recipes.addShaped(<betterstorage:reinforcedChest>.withTag({Material: "steel"}), [[<ore:ingotSteel>, <ore:logWood>, <ore:ingotSteel>], [<ore:logWood>, <ore:craftingChest>, <ore:logWood>], [<ore:ingotSteel>, <ore:craftingToolHardSaw>.transformDamage(), <ore:ingotSteel>]]);
