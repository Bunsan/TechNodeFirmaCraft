...
recipes.addShaped(<PneumaticCraft:assemblyLaser>, [[<ore:dyeRed>, <PneumaticCraft:pneumaticCilinder>, <PneumaticCraft:pneumaticCilinder>], [null, null, <PneumaticCraft:pneumaticCilinder>], [<ore:ingotIronCompressed>, <PneumaticCraft:printedCircuitBoard>, <ore:ingotIronCompressed>]]);
		...
		for item in <ore:craftingToolHardHammer>.items {
	recipes.addShaped(<PneumaticCraft:omnidirectionalHopper>, [[null, item.anyDamage().transformDamage(), null], [<ore:ingotIronCompressed>, <terrafirmacraft:Hopper>, <ore:ingotIronCompressed>], [null, <ore:ingotIronCompressed>, null]]);
	recipes.addShaped(<PneumaticCraft:liquidHopper>, [[<ore:blockGlass>, item.anyDamage().transformDamage(), <ore:blockGlass>], [<ore:blockGlass>, <terrafirmacraft:Hopper>, <ore:blockGlass>], [null, <ore:blockGlass>, null]]);
