...
//#ADD SHAPED
	...
	recipes.addShaped(<PneumaticCraft:airCompressor>, [[<ore:ingotIronCompressed>, <ore:ingotIronCompressed>, <ore:ingotIronCompressed>], [<ore:ingotIronCompressed>, <ore:craftingToolHardHammer>.transformDamage(), <PneumaticCraft:pressureTube>], [<ore:ingotIronCompressed>, <Railcraft:machine.beta:5>, <ore:ingotIronCompressed>]]);
	recipes.addShaped(<PneumaticCraft:advancedAirCompressor>, [[<ore:ingotIronCompressed>, <ore:ingotIronCompressed>, <ore:ingotIronCompressed>], [<ore:ingotIronCompressed>, <ore:craftingToolHardHammer>.transformDamage(), <PneumaticCraft:advancedPressureTube>], [<ore:ingotIronCompressed>, <PneumaticCraft:airCompressor>, <ore:ingotIronCompressed>]]);
	...
	recipes.addShaped(<PneumaticCraft:omnidirectionalHopper>, [[null, <ore:craftingToolHardHammer>.transformDamage(), null], [<ore:ingotIronCompressed>, <terrafirmacraft:Hopper>, <ore:ingotIronCompressed>], [null, <ore:ingotIronCompressed>, null]]);
	recipes.addShaped(<PneumaticCraft:liquidHopper>, [[<ore:blockGlass>, <ore:craftingToolHardHammer>.transformDamage(), <ore:blockGlass>], [<ore:blockGlass>, <terrafirmacraft:Hopper>, <ore:blockGlass>], [null, <ore:blockGlass>, null]]);
	recipes.addShaped(<PneumaticCraft:pressureChamberWall> * 4, [[<ore:ingotIronCompressed>, <ore:ingotIronCompressed>, <ore:ingotIronCompressed>], [<ore:ingotIronCompressed>, <ore:craftingToolHardHammer>.transformDamage(), <ore:ingotIronCompressed>], [<ore:ingotIronCompressed>, <ore:ingotIronCompressed>, <ore:ingotIronCompressed>]]);
	recipes.addShaped(<PneumaticCraft:pressureChamberValve>, [[<ore:craftingToolHardHammer>.transformDamage(), <PneumaticCraft:pressureChamberWall>, null], [<PneumaticCraft:pressureChamberWall>, <PneumaticCraft:pressureTube>, <PneumaticCraft:pressureChamberWall>], [null, <PneumaticCraft:pressureChamberWall>, null]]);
	recipes.addShaped(<PneumaticCraft:pressureChamberWall:6>, [[<ore:craftingToolHardHammer>.transformDamage(), <PneumaticCraft:pressureChamberWall>, null], [<PneumaticCraft:pressureChamberWall>, <ore:blockGlass>, <PneumaticCraft:pressureChamberWall>], [null, <PneumaticCraft:pressureChamberWall>, null]]);
	recipes.addShaped(<PneumaticCraft:aerialInterface>, [[<ore:pressureChamber>, <minecraft:hopper>, <ore:pressureChamber>], [<minecraft:ender_pearl>, <ore:craftingToolHardHammer>.transformDamage(), <minecraft:ender_pearl>], [<ore:pressureChamber>, <PneumaticCraft:advancedPressureTube>, <ore:pressureChamber>]]);
