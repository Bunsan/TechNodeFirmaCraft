...
//#ADD SHAPED
	...
	recipes.addShaped(<RopesPlus:blockRopeCentral> * 3, [[<terrafirmacraft:item.Jute Fibre>, <terrafirmacraft:item.Jute Fibre>], [<terrafirmacraft:item.Jute Fibre>, <terrafirmacraft:item.Jute Fibre>]]);
	recipes.addShaped(<RopesPlus:blockRopeCentral> * 3, [[<ImmersiveEngineering:material:3>, <ImmersiveEngineering:material:3>, <ImmersiveEngineering:material:3>], [<ImmersiveEngineering:material:3>, <ImmersiveEngineering:material:3>, <ImmersiveEngineering:material:3>], [<ImmersiveEngineering:material:3>, <ImmersiveEngineering:material:3>, <ImmersiveEngineering:material:3>]]);
